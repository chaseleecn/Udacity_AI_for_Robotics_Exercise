...
def run(param1, param2, param3):
    ...
    # Enter code here
    #
    cross_error_hist = myrobot.y
    error_sum = 0
    for i in range(N):
        cross_error = myrobot.y
        error_sum += cross_error
        steer = - param1 * cross_error - param2 * (cross_error - cross_error_hist) - param3 * error_sum
        myrobot = myrobot.move(steer, speed)
        cross_error_hist = cross_error
        print myrobot, steer
